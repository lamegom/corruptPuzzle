...
//	public static double COOKIES = Double.MIN_VALUE;
	...
	// The Item Names
	public static String ITEM1 = "Drilling line";
	public static String ITEM2 = "Park in vague for seniors";
	public static String ITEM3 = "Pay with blank check";
	public static String ITEM4 = "Bribe Traffic Guard";
	public static String ITEM5 = "Forging a Medical Certificate";
	public static String ITEM6 = "If you join a political party";
	public static String ITEM7 = "Diverting public money";
	public static String ITEM8 = "Sale bids";
	public static String ITEM9 = "Defrauding Documents";
	public static String ITEM10 = "Finance Militias";
	public static String ITEM11 = "Pay for murder";
	public static String ITEM12 = "Give disappearance in invoices";
